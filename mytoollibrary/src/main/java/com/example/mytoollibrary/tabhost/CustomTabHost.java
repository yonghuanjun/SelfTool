...
public class CustomTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    private void ensureHierarchy(Context context) {
        ...
        if (findViewById(android.R.id.tabs) == null) {
            ...
            // 为了是标签过多时能左右滑动，需要在TabWidget外套一个HorizontalScrollView
            // 如果不需要，只需将HorizontalScrollView去掉，直接将TabWidget加入到ll中
            HorizontalScrollView h=new HorizontalScrollView(getContext());
            h.setFillViewport(true);
            h.setHorizontalScrollBarEnabled(false);
            ll.addView(h, new LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT ,
            ...
            h.addView(tw, new LinearLayout.LayoutParams(
                    ViewGroup.LayoutParams.MATCH_PARENT,
